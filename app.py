...
def main():
    ...
    def cotacao(moeda):
        moedas = ['dolar', 'euro', 'peso argentino','yuan']
        if moeda in moedas:
            page = requests.get(f"""https://www.google.com/search?q={moeda}&oq={moeda}&sclient=gws-wiz-serp&sourceid=chrome&ie=UTF-8""",headers=headers)
